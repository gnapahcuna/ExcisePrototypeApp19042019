...
class _FragmentState extends State<CheckEvidenceSearchScreenFragment> {
  ...
  _navigate(BuildContext context) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => CheckSelectEvidenceScreenFragment()),
    );
                  ...
                  children: <Widget>[Row(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: new Text('ILG60_B_05_00_11_00',
