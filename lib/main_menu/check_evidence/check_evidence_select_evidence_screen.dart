...
class CheckSelectEvidenceScreenFragment extends StatefulWidget {
  @override
  _FragmentState createState() => new _FragmentState();
}
class _FragmentState extends State<CheckSelectEvidenceScreenFragment> {
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Container(
                        ...
                        child: Text(
                          _itemsInit[index].ProductCategory +
                              _itemsInit[index].ProductType + ' > ' +
                              _itemsInit[index].MainBrand +
                              _itemsInit[index].ProductModel + ' > ' +
                  ...
                  children: <Widget>[Row(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: new Text('ILG60_B_05_00_12_00',
